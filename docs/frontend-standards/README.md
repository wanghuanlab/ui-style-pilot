...
本规范以 `docs/frontend-standards/00-design-source.md` 为上游视觉映射依据。落地到你的项目时，请结合实际技术栈、组件库和历史组件现状调整。
...
1. `USAGE.md`
2. `README.md`
3. `10-component-inventory.md`
4. `09-review-checklist.md`
...
4. `06-coding-rules.md`
5. `07-ai-generation-rules.md`
6. `08-page-templates.md`
7. `10-component-inventory.md`
8. `09-review-checklist.md`
...
详细组件盘点见 `10-component-inventory.md`。
