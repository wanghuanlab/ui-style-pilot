...
4. `06-coding-rules.md`：知道哪些写法禁止。
5. `10-component-inventory.md`：知道现在已有组件能做什么。
6. `08-page-templates.md`：开发页面时按模板套结构。
7. `09-review-checklist.md`：提交前按清单自查。
...
5. docs/frontend-standards/10-component-inventory.md
6. docs/frontend-standards/09-review-checklist.md
...
4. 新增小页面时强制从 `@/components` 导入公共组件。
5. 每次提交前贴一次 AI 审查提示词，让 AI 帮你做规范复核。
